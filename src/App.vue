  ...
  .header {
    ...
    .el-submenu {
      ...
      i.icon_left {
        ...
        &.icon_datatrans_w {
          background: url('./img/ic_datatrans_iw.png') center center no-repeat;
          background-size: 16px auto;
          top: 2px;
        }
        &.icon_material_w {
      ...
      &.is-opened {
        i.icon_left {
          ...
          &.icon_datatrans_w {
            background: url('./img/ic_datatrans.png') center center no-repeat;
            background-size: 16px auto;
            top: 2px;
          }
          &.icon_material_w {
          ...
          &.icon_busy_w {
            background: url('./img/ic_busy.png') center center no-repeat;
            background-size: 16px auto;
            top: 2px;
          }
          &.icon_alliance_w {
